...
-- this is for everyone who saved a game in V0.2 or V0.1.3 and loads it up in V0.3, because kChangTime didn't exist and needs a value other than nil
...
function CheckGameLoad()
	...
	-- old game loaded
		...
		-- this variable had its name changed in V0.2, forcing us to check if the game has it stored in its save file
		if Game:GetProperty("sNextSeason_UI") == nil then
			-- old variable name
			sNextSeason_UI = Game:GetProperty("sNextTurnSeason_UI");
		else
